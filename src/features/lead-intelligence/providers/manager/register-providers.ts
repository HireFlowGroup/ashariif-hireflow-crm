  ...
  registry.registerFactory(() =>
    createSearchAdapter(
      buildProviderDefinition({
        ...
        apiKeyEnvVars: ["GOOGLE_CSE_API_KEY", "GOOGLE_SEARCH_API_KEY", "GOOGLE_CSE_CX", "GOOGLE_CSE_ID"],
        skipReason: getGoogleCseConfig() ? undefined : "GOOGLE_CSE_API_KEY/GOOGLE_SEARCH_API_KEY + GOOGLE_CSE_CX/GOOGLE_CSE_ID vereist",
